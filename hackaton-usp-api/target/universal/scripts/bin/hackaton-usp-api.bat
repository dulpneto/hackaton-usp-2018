@REM hackaton-usp-api launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM HACKATON_USP_API_config.txt found in the HACKATON_USP_API_HOME.
@setlocal enabledelayedexpansion

@echo off


if "%HACKATON_USP_API_HOME%"=="" (
  set "APP_HOME=%~dp0\\.."

  rem Also set the old env name for backwards compatibility
  set "HACKATON_USP_API_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%HACKATON_USP_API_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\HACKATON_USP_API_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running hackaton-usp-api.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !HACKATON_USP_API_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
